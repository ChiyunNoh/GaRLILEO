...
mkdir ${ROOT_PATH}/thirdparty/ctraj-build
# shellcheck disable=SC2164
cd "${ROOT_PATH}"/thirdparty/ctraj-build
...
echo "-----------------------"
make -j8
cmake --install . --prefix ${ROOT_PATH}/thirdparty/ctraj-install
